...
var smskmaxabs = tryRequire( resolve( __dirname, './../lib/smskmaxabs.native.js' ) );
var opts = {
...
tape( 'the function has an arity of 5', opts, function test( t ) {
	t.strictEqual( smskmaxabs.length, 5, 'has expected arity' );
	t.end();
});
...
tape( 'the function calculates the maximum absolute value of a strided array according to a mask', opts, function test( t ) {
	...
	v = smskmaxabs( x.length, x, 1, mask, 1 );
...
tape( 'if provided an `N` parameter less than or equal to `0`, the function returns `NaN`', opts, function test( t ) {
	...
	v = smskmaxabs( 0, x, 1, mask, 1 );
	t.strictEqual( isnanf( v ), true, 'returns expected value' );

	v = smskmaxabs( -1, x, 1, mask, 1 );
	t.strictEqual( isnanf( v ), true, 'returns expected value' );
